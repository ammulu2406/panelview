...
app.get("/", function(req, res) {
    ...
    var test_data = ['What does HTML stand for?', 'What is the default port number for HTTP?', 'Which programming language is primarily used for iOS app development?', 'Which tool is used for version control?','Name a popular cloud platform.'];
    // Send the array through to the template as a variable called data
    res.render("index", {'title':'QUIZ APP', 
        'heading':'PANEL GAMING', 'data':test_data});
});
...
app.get("/single-programme/:id", function (req, res) {
    ...
    var pSql = "SELECT * FROM my_table WHERE id = ?";
